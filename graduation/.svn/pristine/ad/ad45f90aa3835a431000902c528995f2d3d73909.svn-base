...
public class Testtt extends ApplicationWindow {
	...
	public Control createContents(Composite parent) {
		...
		// 设置窗体标题
		parent.getShell().setText("TextEditor 实例");
	...
	class NewCreateAction extends Action {
		public NewCreateAction() {
			...
			try {
				// 载入图像
				ImageDescriptor icon = ImageDescriptor.createFromURL(new URL("file:icons/new.gif"));
	...
	class OpenFileAction extends Action {
		public OpenFileAction() {
			...
			try {
				// 载入图像
				ImageDescriptor icon = ImageDescriptor.createFromURL(new URL("file:icons/open.gif"));
				setImageDescriptor(icon);
			} catch (MalformedURLException e) {
				System.err.println(e.getMessage());
			}
	...
	class SaveFileAction extends Action {
		public SaveFileAction() {
			...
			try {
				// 载入图像
				ImageDescriptor icon = ImageDescriptor.createFromURL(new URL("file:icons/save.gif"));
				setImageDescriptor(icon);
			} catch (MalformedURLException e) {
				System.err.println(e.getMessage());
			}
	...
	class CopyFileAction extends Action {
		public CopyFileAction() {
			...
			try {
				// 载入图像
				ImageDescriptor icon = ImageDescriptor.createFromURL(new URL("file:icons/copy.gif"));
				setImageDescriptor(icon);
			} catch (MalformedURLException e) {
				System.err.println(e.getMessage());
			}
	...
	class PasteFileAction extends Action {
		public PasteFileAction() {
			...
			try {
				// 载入图像
				ImageDescriptor icon = ImageDescriptor.createFromURL(new URL("file:icons/paste.gif"));
				setImageDescriptor(icon);
			} catch (MalformedURLException e) {
				System.err.println(e.getMessage());
			}
	...
	class CutFileAction extends Action {
		public CutFileAction() {
			...
			try {
				// 载入图像
				ImageDescriptor icon = ImageDescriptor.createFromURL(new URL("file:icons/cut.gif"));
				setImageDescriptor(icon);
			} catch (MalformedURLException e) {
				System.err.println(e.getMessage());
			}
	...
	class BlodAction extends Action {
		public BlodAction() {
			...
			try {
				// 载入图像
				ImageDescriptor icon = ImageDescriptor.createFromURL(new URL("file:icons/blod.bmp"));
				setImageDescriptor(icon);
			} catch (MalformedURLException e) {
				System.err.println(e.getMessage());
			}
	...
	class ItalicAction extends Action {
		public ItalicAction() {
			...
			try {
				// 载入图像
				ImageDescriptor icon = ImageDescriptor.createFromURL(new URL("file:icons/italic.bmp"));
				setImageDescriptor(icon);
			} catch (MalformedURLException e) {
				System.err.println(e.getMessage());
			}
	...
	class UnderlineAction extends Action {
		public UnderlineAction() {
			...
			try {
				// 载入图像
				ImageDescriptor icon = ImageDescriptor.createFromURL(new URL("file:icons/underline.bmp"));
				setImageDescriptor(icon);
			} catch (MalformedURLException e) {
				System.err.println(e.getMessage());
			}
